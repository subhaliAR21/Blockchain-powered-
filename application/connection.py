...
def get_contract_abi():
    certification_json_path = Path(__file__).parent.parent / 'build' / 'contracts' / 'Certification.json'
...
deployment_config_fpath = Path(__file__).parent.parent / "deployment_config.json"
